/**
 * ProtectedPaymentEscrowV2 ABI — generated from the Foundry build artifact.
 *
 * Source artifact: contracts/out/ProtectedPaymentEscrowV2.sol/ProtectedPaymentEscrowV2.json
 * Regenerate with: npm run abi:export   (after `forge build` in contracts/)
 *
 * DO NOT EDIT BY HAND.
 */
export const protectedPaymentEscrowV2ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
  ...
  {
    "type": "function",
    "name": "getAutoReleaseEligibility",
    "inputs": [
      {
        "name": "paymentId",
        "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ProtectedPaymentEscrowV2.Payment",
        "components": [
          {
            "name": "paymentId",
            "type": "uint256",
          ...
          },
          {
            "name": "state",
            "type": "uint8",
            "internalType": "enum ProtectedPaymentEscrowV2.State"
          },
          {
            "name": "createdAt",
            "type": "uint64",
