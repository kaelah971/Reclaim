-- ============================================================================
-- 00008: Atomic tool-execution reservation function
--
-- Adds a `current_running_tool_id` column to resolution_agents and provides
-- an RPC function that atomically:
--   1. Validates agent existence, version, lifecycle, and budget
--   2. Checks for idempotent existing execution
--   3. Creates a new tool_execution row and updates the agent atomically
-- ============================================================================

-- Add current_running_tool_id column to resolution_agents
ALTER TABLE resolution_agents ADD COLUMN IF NOT EXISTS current_running_tool_id TEXT;

-- ============================================================================
-- Function: reserve_resolution_agent_tool_execution
-- ============================================================================
